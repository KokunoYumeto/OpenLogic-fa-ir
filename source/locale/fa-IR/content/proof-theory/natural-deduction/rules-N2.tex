...
\DisplayProof
\end{tabular}
\caption{قواعد \Log{N2c} و \Log{N2i}. در \Intro{\lforall} و
\Elim{\lexists}، !!{constant}~$a$ نباید در دنبالهٔ نتیجه ظاهر شود.
$\Gamma_i$ها مجموعه‌هایی از !!{formula}های برچسب‌دار~$x:!A$ هستند.
\Log{N2i} شامل \FalseCl نیست.}
\ollabel{tab:N2}
\end{table}
