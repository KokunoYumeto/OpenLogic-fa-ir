...
\olsection{\usetoken{P}{derivation}های سکوئنت برای~\Log{K}}

\iftag{prvBox}{

\begin{ex}
  یک !!{derivation} در حساب سکوئنت ارائه می‌کنیم که نشان می‌دهد
...
\iftag{notprvBox,notprvDiamond}{}{
  این یک !!a{derivation} برای~\Dual{} است.
  \begin{prooftree}
    \Axiom$!A \fCenter !A$
...
\begin{prob}
  برای !!{formula}های زیر، اثبات‌هایی در حساب سکوئنتِ~$\Log{K}$ بیابید:
  \begin{enumerate}
