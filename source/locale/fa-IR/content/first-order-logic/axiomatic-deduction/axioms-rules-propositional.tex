...
\olsection{اصول موضوع و قواعد ادات گزاره‌ای}

\begin{defn}[اصول موضوع]
مجموعهٔ $\PAx$ از \emph{اصول موضوع} ادات گزاره‌ای همهٔ !!{formula}s
به صورت‌های زیر را دربر می‌گیرد:
\begin{align}
...
\begin{defn}[وضع مقدم]
  اگر $!B$ و $!B \lif !A$ پیش‌تر در !!a{derivation} آمده باشند، آنگاه
  $!A$ گام استنتاجی درستی است.
\end{defn}

قاعدهٔ وضع مقدم را به‌اختصار «\MP» می‌نامیم.
