...
After any context loss, reconstruct this lane from `DURABLE_STATE.md`, verify
`DURABLE_STATE.sha256`, and read the raw receipts it names. Conversation
summaries are discovery hints only and do not establish state or evidence.
...
| `fa_IR` | Iranian Persian | Wave 2 held | Independent Persian terminology and review lane; no continuation during Arabic Wave 1. |
...
Arabic Noether Paper 06 is the active Wave 1 workpass. Its cumulative opening
checkpoint covers `P06-S0002` and `P06-S0004--P06-S0015`; its continuation
cursor is `P06-S0016`. Iranian Persian remains frozen independently at
`P06-S0002`, `P06-S0004`, and `P06-S0005`, with a held Wave 2 cursor of
`P06-S0006`.
